...
?>
        ...
        <div class="main-slider swiper-container h600" style="">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide position-relative">
                    <img src="<?php echo get_template_directory_uri();?>/img/slide1.jpg" data-rjs="2" alt="">
                ...
                <div class="swiper-slide position-relative">
                    <img src="<?php echo get_template_directory_uri();?>/img/slide2.jpg" data-rjs="2" alt="">
                    <div class="slide-content container">
                        <div class="row align-items-center">
                            <div class=" col-xl-6 col-lg-8">
                                <div class="slide-content-inner">
            ...
            <div class="row align-items-center pb-80">
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="text-center" data-animate="fadeInUp" data-delay=".1">
                        <img src="<?php echo get_template_directory_uri();?>/img/number-one.png" alt="" data-rjs="2">
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="theme-bg-overlay bg-img-md-none pt-120 pb-90" data-bg-img="<?php echo get_template_directory_uri();?>/img/rocket.jpg" data-rjs="2">
        <div class="container">
            <div class="row justify-content-center">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service single-service-white text-center" data-animate="fadeInUp" data-delay=".1">
                        <img src="<?php echo get_template_directory_uri();?>/img/icons/earth.svg" alt="" class="svg">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service single-service-white text-center" data-animate="fadeInUp" data-delay=".4">
                        <img src="<?php echo get_template_directory_uri();?>/img/icons/phone.svg" alt="" class="svg">
                        <h4>Phone Service</h4>
                        <p>Lorem ipsum dolor sit ametteturmpor incididunt most popular.</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service single-service-white text-center" data-animate="fadeInUp" data-delay=".7">
                        <img src="<?php echo get_template_directory_uri();?>/img/icons/tv.svg" alt="" class="svg">
                        <h4>Cable TV</h4>
                        <p>Lorem ipsum dolor sit ametteturmpor incididunt most popular.</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service single-service-white text-center" data-animate="fadeInUp" data-delay="1">
                        <img src="<?php echo get_template_directory_uri();?>/img/icons/server.svg" alt="" class="svg">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".05">
                        <div class="single-feature-img">
                            <img src="<?php echo get_template_directory_uri();?>/img/icons/ftp.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".2">
                        <div class="single-feature-img">
                            <img src="<?php echo get_template_directory_uri();?>/img/icons/upgrade.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".35">
                        <div class="single-feature-img">
                            <img src="<?php echo get_template_directory_uri();?>/img/icons/data.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".5">
                        <div class="single-feature-img">
                            <img src="<?php echo get_template_directory_uri();?>/img/icons/lock.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".65">
                        <div class="single-feature-img">
                            <img src="<?php echo get_template_directory_uri();?>/img/icons/cloud.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-feature single-feature-img-left text-left" data-animate="fadeInUp" data-delay=".8">
                        <div class="single-feature-img">
                            <img src="<?php echo get_template_directory_uri();?>/img/icons/access.svg" alt="" class="svg">
                        </div>
                        <div class="single-feature-content">
    ...
    <section class="theme-bg-overlay bg-img-xs-none pt-120 pb-120" data-bg-img="<?php echo get_template_directory_uri();?>/img/earth.jpg" data-rjs="2">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="section-title section-title-white text-center" data-animate="fadeInUp" data-delay=".1">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="popup-video mb-50" data-animate="fadeInUp" data-delay=".4">
                        <img src="<?php echo get_template_directory_uri();?>/img/video-thumb.jpg" data-rjs="2" alt="">
                        ...
                        <div class="swiper-container news-slider">
                            <div class="swiper-wrapper">
                                <div class="single-news swiper-slide">
                                    ...
                                    <img src="<?php echo get_template_directory_uri();?>/img/posts/post1.jpg" data-rjs="2" alt="">
                                    <ul class="list-unstyled d-flex align-items-center">
                                        <li><img src="<?php echo get_template_directory_uri();?>/img/authors/author1.jpg" alt=""></li>
                                ...
                                <div class="single-news swiper-slide">
                                    <a class="tip" href="#">News</a>
                                    <img src="<?php echo get_template_directory_uri();?>/img/posts/post2.jpg" data-rjs="2" alt="">
                                    <ul class="list-unstyled d-flex align-items-center">
                                        <li><img src="<?php echo get_template_directory_uri();?>/img/authors/male.png" alt=""></li>
                                        <li>by <a href="#">Zane M. Frye</a></li>
                                        <li><a href="#">January 19, 2018</a></li>
                                    </ul>
                                ...
                                <div class="single-news swiper-slide">
                                    <a class="tip" href="#">News</a>
                                    <img src="<?php echo get_template_directory_uri();?>/img/posts/post3.jpg" data-rjs="2" alt="">
                                    <ul class="list-unstyled d-flex align-items-center">
                                        <li><img src="<?php echo get_template_directory_uri();?>/img/authors/female.png" alt=""></li>
                                        <li>by <a href="#">Zane M. Frye</a></li>
                                        <li><a href="#">January 19, 2018</a></li>
                                    </ul>
                        ...
                        <div class="swiper-container product-carousel">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide single-product">
                                    ...
                                    <img src="<?php echo get_template_directory_uri();?>/img/products/product1.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <div class="swiper-slide single-product">
                                    ...
                                    <img src="<?php echo get_template_directory_uri();?>/img/products/product2.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <div class="swiper-slide single-product">
                                    <span class="tip">New</span>
                                    <img src="<?php echo get_template_directory_uri();?>/img/products/product3.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <div class="swiper-slide single-product">
                                    <span class="tip">New</span>
                                    <img src="<?php echo get_template_directory_uri();?>/img/products/product4.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <div class="swiper-slide single-product">
                                    <span class="tip">New</span>
                                    <span class="discount">25% off</span>
                                    <img src="<?php echo get_template_directory_uri();?>/img/products/product5.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                ...
                                <div class="swiper-slide single-product">
                                    <span class="tip">New</span>
                                    <span class="discount">25% off</span>
                                    <img src="<?php echo get_template_directory_uri();?>/img/products/product6.jpg" data-rjs="2" alt="">
                                    <ul class="list-inline">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
