    <footer class="main-footer">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget mb-30" data-animate="fadeInUp" data-delay=".1">
                            ...
                            <div class="contact-widget-content">
                                <p>Check any ideas or questions you have with us.</p>
                                <ul class="list-unstyled">
                                    <li>
                                        <i class="fa fa-phone"></i>
                                        <a href="tel:+1234567890">(+34) 640366468</a>
                                    </li>
                                    <li>
                                        <i class="fa fa-envelope-o"></i>
                                        <a href="mailto:serviney.demo@fakemail.com">info@infowifi.com</a>
                                    </li>
                                    <li>
                                        <i class="fa fa-map-marker"></i>
                                        <span>Calle Primavera, 26, 18008 Granada</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="copyright-text text-center text-md-left">
                            <p class="mb-md-0">© 2020 InfoWifi.  All rights reserved.</p>
                        </div>
                    </div>
        ...
        <a href="#"> <i class="fa fa-chevron-up" style="width: 100%;height: 89%;display: flex;justify-content: center;align-items: center;"></i></a>
    </div>
